...
public class AlubmListView extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_alubm_list_view);
        ...
        SimpleAdapter adapter = new SimpleAdapter(getApplicationContext(), aList, R.layout.music_album_row_view, keys, view);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Toast.makeText(AlubmListView.this, "Enter Click Event",Toast.LENGTH_LONG);
